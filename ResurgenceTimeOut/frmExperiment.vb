...
Public Class frmExperiment
    ...
    Private Sub WriteDataFile()
        ...
        swWriteResults.WriteLine("  Resultados del Participante " & frmMain.txtParticipantID.Text & " on " & DateString)
        swWriteResults.WriteLine("  Sesion a cargo de " & frmMain.txtExperimenterID.Text)
        swWriteResults.WriteLine("  Palanca Izquierda: " & CStr(frmMain.cmbLeft.SelectedItem))
        swWriteResults.WriteLine("  Palanca Central: " & CStr(frmMain.cmbMiddle.SelectedItem))
        swWriteResults.WriteLine("  Palanca Derecha: " & CStr(frmMain.cmbRight.SelectedItem))
        swWriteResults.WriteLine("  Duracion Fase 1 = " & CStr(frmMain.nudPhase1Duration.Value) & " min")
        swWriteResults.WriteLine("  Duracion Fase 2 = " & CStr(frmMain.nudPhase2Duration.Value) & " min")
        ...
        swWriteResults.WriteLine("  Final de Sesion: " & Now)
        swWriteResults.WriteLine("")
        swWriteResults.WriteLine("Datos de Sesion___________________________________________________________")
        swWriteResults.WriteLine("")
        swWriteResults.WriteLine("Componente Sin Time Out (Blue)_________________________________________________________")
        ...
        swWriteResults.WriteLine("1 = Respuesta Objetivo")
        swWriteResults.WriteLine("2 = Respuesta Alternativa")
        swWriteResults.WriteLine("3 = Respuesta Control")
        swWriteResults.WriteLine("4 = Respuesta Off-Key")
        swWriteResults.WriteLine("5 = Inicio de Time Out")
        swWriteResults.WriteLine("6 = Final de Time Out")
        swWriteResults.WriteLine("7 = Inicio de Repuesta Consumatoria")
        swWriteResults.WriteLine("8 = Final de Respuesta Consumatoria")
        swWriteResults.WriteLine("50 = Cambio de Rojo a Azul")
        swWriteResults.WriteLine("51 = Cambio de Azul a Rojo")
        swWriteResults.WriteLine("98 = Sesion terminada")
        swWriteResults.WriteLine("99 = Sesion terminada")

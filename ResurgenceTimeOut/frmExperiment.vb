...
Public Class frmExperiment
    ...
    Private Sub WriteDataFile()
        ...
        swWriteResults.WriteLine("  Botón Izquierdo: " & CStr(frmMain.cmbLeft.SelectedItem))
        swWriteResults.WriteLine("  Botón Central: " & CStr(frmMain.cmbMiddle.SelectedItem))
        swWriteResults.WriteLine("  Botón Derecho: " & CStr(frmMain.cmbRight.SelectedItem))
